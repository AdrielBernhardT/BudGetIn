<x-common.component-card title="Textarea input fields">
    ...
    <div>
        ...
        <textarea placeholder="{{ __('sentence.description_placeholder') }}" type="text" rows="6"
    ...
    <div>
        ...
        <textarea placeholder="{{ __('sentence.description_placeholder') }}" type="text" rows="6" disabled
    ...
    <div>
        ...
        <p class="text-theme-xs text-error-500">
            {{ __('sentence.please_enter_a_message_in_the_textarea') }}
        </p>
    </div>
