...
<div class="flex items-center gap-2">
    ...
    <form
        action=""
        method="POST"
        class="js-delete-form flex items-center"
    ...
    >
        ...
        <button
            type="submit"
            class="flex h-5 w-5 items-center justify-center shrink-0 leading-none text-gray-500 hover:text-error-500 dark:text-gray-400 dark:hover:text-error-500"
        >
            <svg class="fill-current block" width="21" height="21" viewBox="0 0 21 21"
    ...
    <button
        type="button"
        @click="window.dispatchEvent(new CustomEvent('edit-goal', {
            detail: {
                goal: @js([
                    'id' => $goal->id,
                    'name' => $goal->name,
        ...
        class="flex h-5 w-5 items-center justify-center shrink-0 leading-none text-gray-500 hover:text-accent dark:text-gray-400 dark:hover:text-accent"
    >
        <svg class="fill-current block" width="21" height="21" viewBox="0 0 21 21"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
