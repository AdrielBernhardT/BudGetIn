        ...
        <div x-data="{
            ...
            <div class="px-2 pr-14">
                <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                    {{ __('sentence.add_goal') }}
                </h4>
                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                    {{ __('sentence.create_a_new_financial_goal_to_track_your_savings_and_investments') }}
                </p>
            </div>
                ...
                <div class="custom-scrollbar max-h-[40vh] lg:max-h-[60vh] flex flex-col gap-5 overflow-y-auto p-2">
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('sentence.goal_name') }}<span class="text-red-500">*</span>
                        </label>
                    ...
                    <div>
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('sentence.target_amount') }}<span class="text-red-500">*</span>
                        </label>
                        <div class="relative">
                            <span
