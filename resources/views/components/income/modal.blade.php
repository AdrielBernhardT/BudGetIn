    ...
    <div x-data="{
        ...
        <div class="px-2 pr-14">
            <template x-if="mode === 'create'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('sentence.add_new') }} {{ __('nav.income') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                        {{ __('sentence.add_income_details') }}
                    </p>
                </div>
            </template>
            ...
            <template x-if="mode === 'edit'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('sentence.edit_income') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                        {{ __('sentence.update_income_details') }}
                    </p>
                </div>
            </template>
        </div>
            ...
            <div class="custom-scrollbar max-h-[40vh] lg:max-h-[60vh] flex flex-col gap-5 overflow-y-auto p-2">
                <div>
                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        {{ __('sentence.income_title') }}<span class="text-red-500">*</span>
                    </label>
                ...
                <div>
                    ...
                    <textarea x-model="income.description" placeholder="{{ __('sentence.description_placeholder') }}" type="text" rows="6" name="description"
                ...
                <div class="mt-6 flex items-center gap-3 px-2 lg:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="mode === 'create' ? '{{ __('sentence.save_changes') }}' : '{{ __('sentence.update_income') }}'"></span>
                    </button>
                </div>
            </div>
        </form>
