    ...
    <div x-data="{
        ...
        <div class="px-2 pr-14">
            <template x-if="mode === 'create'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('sentence.add_new') }} {{ __('nav.transfer') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                        {{ __('sentence.add_transfer_details') }}
                    </p>
                </div>
            </template>
            ...
            <template x-if="mode === 'edit'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('sentence.edit_transfer') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                        {{ __('sentence.update_transfer_details') }}
                    </p>
                </div>
            </template>
        </div>
            ...
            <div class="custom-scrollbar flex flex-col gap-5 overflow-y-auto max-h-[60vh] p-2">
                <div class="flex flex-row gap-10">
                    <div class="w-1/2">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('sentence.from_account') }}<span class="text-red-500">*</span>
                        </label>
                    ...
                    <div class="w-1/2">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('common.to_account') }}<span class="text-red-500">*</span>
                        </label>
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select
                                name="to_account_id"
                ...
                <div>
                    ...
                    <textarea name="description"
                        x-model="transfer.description" placeholder="{{ __('sentence.description_placeholder') }}" type="text" rows="6"
                ...
                <div class="mt-6 flex items-center gap-3 px-2 lg:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="mode === 'create' ? '{{ __('sentence.save_changes') }}' : '{{ __('sentence.update_transfer') }}'"></span>
                    </button>
                </div>
            </div>
        </form>
