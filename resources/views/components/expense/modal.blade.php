    ...
    <div x-data="{
        ...
        <div class="px-2 pr-14">
            <template x-if="mode === 'create'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('sentence.add_new') }} {{ __('nav.expense') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                       {{ __('sentence.add_expense_details') }}
                    </p>
                </div>
            </template>
            ...
            <template x-if="mode === 'edit'">
                <div>
                    <h4 class="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
                        {{ __('common.edit') }} {{ __('nav.expense') }}
                    </h4>
                    <p class="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                        {{ __('sentence.update_expense_details') }}
                    </p>
                </div>
            </template>
        </div>
        ...
        >
            ...
            <div class="custom-scrollbar max-h-[40vh] lg:max-h-[60vh] flex flex-col gap-5 overflow-y-auto p-2">
                <div class = "flex lg:flex-row flex-col lg:gap-10 gap-5">
                    <div class="lg:w-2/3">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('sentence.expense_title') }}<span class="text-red-500">*</span>
                        </label>
                    ...
                    <div class="lg:w-1/3">
                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            {{ __('nav.category') }}<span class="text-red-500">*</span>
                        </label>
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select
                                ...
                                <option disabled value="">{{ __('sentence.select_category') }}</option>
                    ...
                    <div class="lg:w-1/3">
                        ...
                        <div x-data="{ isOptionSelected: false }" class="relative z-20 bg-transparent">
                            <select
                                ...
                                :class="isOptionSelected && 'text-gray-800 dark:text-white/90'"
                                @change="isOptionSelected = true">
                                <option disabled value="" class="text-gray-700 dark:bg-gray-900  dark:text-gray-400" selected>
                ...
                <div>
                    ...
                    <textarea name="description" x-model="expense.description" placeholder="{{ __('sentence.description_placeholder') }}" type="text" rows="6"
                ...
                <div class="mt-6 flex items-center gap-3 px-2 lg:justify-end">
                    ...
                    <button type="submit"
                        ...
                        <span x-text="mode === 'create' ? '{{ __('sentence.save_changes') }}' : '{{ __('sentence.update_expense') }}'"></span>
                    </button>
                </div>
            </div>
        </form>
