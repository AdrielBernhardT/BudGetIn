                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('auth.enter_email_password_sign_up') }}
                        </p>
                    ...
                    <div>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-white/90">
                                            {{ __('sentence.first_name') }}<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="fname" name="fname"
                                            value="{{ old('fname') }}"
                                            placeholder="{{ __('sentence.enter_first_name') }}"
                                    ...
                                    <div class="sm:col-span-1">
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-white/90">
                                            {{ __('sentence.last_name') }}<span class="text-error-500">*</span>
                                        </label>
                                        <input type="text" id="lname" name="lname"
                                            placeholder="{{ __('sentence.enter_last_name') }}"
                                            value="{{ old('lname') }}"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="{{ __('auth.enter_password') }}"
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-white/90">
                                        {{ __('auth.password_confirmation') }}<span class="text-error-500">*</span>
                                    </label>
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="password_confirmation" placeholder="{{ __('auth.enter_password_confirmation') }}"
                                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                        <span @click="showPassword = !showPassword"
                                            class="absolute top-1/2 right-4 z-30 -translate-y-1/2 cursor-pointer text-gray-500 dark:text-gray-400">
                                            <svg x-show="!showPassword" class="fill-current" width="20" height="20"
                                    ...
                                    <div x-data="{ checkboxToggle: false }">
                                        <label for="checkboxLabelOne"
                                            ...
                                            <p class="inline-block font-normal text-gray-500 dark:text-gray-400">
                                                {!! __('sentence.agree_terms', [
                                                    'terms' => '<span class="text-gray-800 dark:text-white/90">' . __('common.terms_and_conditions') . '</span>',
                                                    'privacy' => '<span class="text-gray-800 dark:text-white">' . __('common.privacy_policy') . '</span>',
                                                ]) !!}
                                            </p>
                                        </label>
                                    </div>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                {{ __('sentence.already_have_account') }}
                                <a href="{{ route('login') }}" class="text-main hover:text-main-hover dark:text-second">{{ __('auth.sign_in') }}</a>
                            </p>
                        </div>
                    </div>
                </div>
