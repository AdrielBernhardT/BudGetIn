    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] lg:p-6">
        ...
        <div class="flex items-center justify-between py-2 border-b border-gray-200 dark:border-gray-800"
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 py-3">
                    Enable browser push notifications for goal &amp; transaction updates.
                </p>
        ...
        return {
            ...
            async init() {
                if (!window.PushNotifications || !window.PushNotifications.isSupported()) {
                    this.error = 'Browser kamu tidak mendukung push notification.';
                    this.loading = false;
                    return;
                }
            ...
            async toggle() {
                ...
                try {
                    ...
                    this.error = e.message || 'Gagal mengubah pengaturan notifikasi.';
